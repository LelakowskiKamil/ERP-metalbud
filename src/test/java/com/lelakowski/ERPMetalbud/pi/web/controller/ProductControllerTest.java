...
class ProductControllerTest {
    ...
    void test1() throws Exception {
        Color color = new Color("Red", "Czerwony", Collections.emptyList());
        colorRepository.save(color);
        Dimension dimensionHeight = new Dimension(1.5, "mm", Collections.emptyList(), Collections.emptyList(), Collections.emptyList());
        Dimension dimensionWidth = new Dimension(1.5, "mm", Collections.emptyList(), Collections.emptyList(), Collections.emptyList());
        Dimension dimensionLength = new Dimension(1.5, "mm", Collections.emptyList(), Collections.emptyList(), Collections.emptyList());
        dimensionRepository.save(dimensionHeight);
        dimensionRepository.save(dimensionWidth);
        dimensionRepository.save(dimensionLength);
        Dimensions dimensions = new Dimensions("testDimension", dimensionHeight, dimensionWidth, dimensionLength, Collections.emptyList());
        dimensionsRepository.save(dimensions);
        ProductSpecification productSpecification = new ProductSpecification("testProductSpec", dimensions, Collections.emptyList());
        productSpecificationRepository.save(productSpecification);
        ProductDetails productDetails = new ProductDetails(color, productSpecification, Collections.emptyList());
        productDetailsRepository.save(productDetails);
        Vendor vendor = new Vendor("vendor", Collections.emptyList());
        vendorRepository.save(vendor);
        Brand brand = new Brand("brand", Collections.emptyList());
        brandRepository.save(brand);
        Price price = new Price(1.5, "PLN", Collections.emptyList(), Collections.emptyList());
        priceRepository.save(price);
        Product product = new Product("product", productDetails, vendor, brand, price, Collections.emptyList(), Collections.emptyList());
    ...
    void test2() throws Exception {
        ...
        CreateProductCommand createProductCommand = new CreateProductCommand(
                "product", createProductDetailsCommand, 1L, 1L, Collections.emptyList(), 1.5, "PLN"
        );
    ...
    void test3() throws Exception {
        ...
        CreateProductCommand createProductCommand = new CreateProductCommand(
                "product", createProductDetailsCommand, 1L, 1L, Collections.emptyList(), 1.5, ""
        );
