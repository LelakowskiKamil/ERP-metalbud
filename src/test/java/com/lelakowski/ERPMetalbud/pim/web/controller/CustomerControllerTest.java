...
class CustomerControllerTest {
    ...
    void test1() throws Exception {
        ...
        Account account = new Account("admin", "!Admin123", "admin@admin.pl", privileges, Collections.emptyList());
        accountRepository.save(account);
        Address address = new Address("Mielec", "12343424", "Podkarpackie", "Poland", Collections.emptyList());
        addressRepository.save(address);
        Customer customer = new Customer("Kamil", "Lelakowski", account, address, Collections.emptyList());
