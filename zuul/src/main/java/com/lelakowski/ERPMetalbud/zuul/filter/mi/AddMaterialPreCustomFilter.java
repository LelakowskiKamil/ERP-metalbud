package com.lelakowski.ERPMetalbud.zuul.filter.mi;
...
@Component
@Slf4j
public class AddMaterialPreCustomFilter extends ZuulFilter {
    @Override
    ...
    public boolean shouldFilter() {
        ...
        return context.getRequest().getRequestURI().startsWith("/api/v1/mi/materials");
    }
