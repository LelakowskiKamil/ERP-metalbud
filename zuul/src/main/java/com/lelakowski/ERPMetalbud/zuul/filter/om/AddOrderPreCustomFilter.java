package com.lelakowski.ERPMetalbud.zuul.filter.om;
...
@Component
@Slf4j
public class AddOrderPreCustomFilter extends ZuulFilter {
    @Override
    ...
    public boolean shouldFilter() {
        ...
        return context.getRequest().getRequestURI().startsWith("/api/v1/om/orders");
    }
