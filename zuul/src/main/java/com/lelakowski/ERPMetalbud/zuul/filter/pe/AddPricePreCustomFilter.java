package com.lelakowski.ERPMetalbud.zuul.filter.pe;
...
@Component
@Slf4j
public class AddPricePreCustomFilter extends ZuulFilter {
    @Override
    ...
    public boolean shouldFilter() {
        ...
        return context.getRequest().getRequestURI().startsWith("/api/v1/pe/prices");
    }
