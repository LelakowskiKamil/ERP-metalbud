package com.lelakowski.ERPMetalbud.zuul.filter.pi;
...
@Component
@Slf4j
public class AddProductPreCustomFilter extends ZuulFilter {
    @Override
    ...
    public boolean shouldFilter() {
        ...
        return context.getRequest().getRequestURI().startsWith("/api/v1/pi/products");
    }
